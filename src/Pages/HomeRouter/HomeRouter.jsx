...
export const HomeRouter = (props) => {
    ...
    return (
        ...
        <Routes>
            ...
            <Route path="recipes" element={<RecipesContainer dataSite={props.dataSite.recipesPage} />}  />
            <Route path="profile/:id" element={<ProfilePageContainer dataEmpty={props.dataSite.emptyPage} dataSite={props.dataSite.profilePage}/>}  />
            <Route path="recipes/:id" element={<RecipePageContainer dataSite={props.dataSite.recipePage} dataEmpty={props.dataSite.emptyPage} />}  />
            <Route path="profile/add_recipe" element={<CreateRecipeContainer dataSite={props.dataSite.createRecipePage} />}  />
            <Route path="profile/:id/settings" element={<SettingPageContainer dataSite={props.dataSite.settingPage} />}  />
            <Route path="search" element={<SearchPage searchValue={searchValue} dataEmpty={props.dataSite.emptyPage} />} />
            <Route path="recipes/:id/settings" element={<SettingRecipePage />}  />
            <Route path="*" element={<EmptyPage data={props.dataSite.emptyPage}/>}  />
        </Routes>
        </>
    )
    } else return (
        ...
        {(!isAuth && !loadingPage) && <LoginEmptyPage data={props.dataSite.loginEmptyPage}/>}
        </>
        )
}
